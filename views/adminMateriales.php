...
<div class="row">
    <div class="col-md-12" id="formulario_add">
        <div class="card card-dark">
            ...
            <div class="card-body">
                <form id="material_add" method="POST">
                    <input type="hidden" id="existeMaterial" name="existeMaterial">
                    <div class="form-row">
...
<div class="row">
    <div class="col-md-12" id="formulario_update" style="display: none;">
        <div class="card card-dark">
            <div class="card-header">
                <h3 class="card-title">Modificar Material</h3>
            </div>
            <div class="card-body">
                <form id="material_update" method="POST">
                    <input type="hidden" id="EId" name="id">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="Enombre">Nombre del Material</label>
